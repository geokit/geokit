  ...
  module Geocoders
    ...
    class YahooGeocoder < Geocoder
      ...
      def self.do_geocode(address, options = {})
        ...
        url="http://yboss.yahooapis.com/geo/placefinder?q=#{Geokit::Inflector::url_escape(address_str)}&flags=J"

        o = OauthUtil.new
        o.consumer_key = Geocoders::yahoo_consumer_key
        o.consumer_secret = Geocoders::yahoo_consumer_secret
        parsed_url = URI.parse(url)
        url="http://yboss.yahooapis.com/geo/placefinder?#{o.sign(parsed_url).query_string}"
